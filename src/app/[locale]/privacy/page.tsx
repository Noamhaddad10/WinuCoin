    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main id="main-content" className="flex-1">
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 rounded-xl border border-slate-100 bg-slate-50 p-4 text-sm text-slate-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-slate-400">
            {t('contact')}
          </div>
